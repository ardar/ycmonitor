...
#define XFILTER_SERVICE_DLL_NAME	_T("socksfilter.dll")
#define REG_INSTALL_KEY				_T("SYSTEM\\CurrentControlSet\\Services\\WinSock2\\Winsock_Spi")
...
public:
	...
	int		InstallProvider(TCHAR *sPathName,TCHAR *sProcessName);
	int		RemoveProvider();
...
public:
	...
	TCHAR m_sProcessPathName[MAX_PATH];
};